      ...
      <form class="w-full max-w-lg mx-auto">
        ...
        <div class="relative">
          ...
          <input type="search" id="default-search"
            class="block w-full p-4 pl-10 text-sm text-slate-700 border border-slate-200 rounded-lg bg-slate-50 focus:ring-sky-500 focus:border-sky-500 outline-none transition-all"
    ...
    <section class="flex flex-col lg:flex-row gap-10 w-full">
      ...
      <div class="w-full lg:w-2/3 flex flex-col">
        ...
        <div class="flex flex-col sm:flex-row mt-4 items-start gap-4 sm:gap-6 w-full">
          <a href="/slug"
            class="hover:underline font-jakarta text-2xl sm:text-3xl md:text-4xl font-medium text-slate-700 w-full sm:w-3/4">
      ...
      <div class="w-full lg:w-1/3 grid content-start divide-y divide-dashed divide-slate-500">
        <div class="grid py-4">
          ...
          <a href="/slug"
            class="text-slate-700 hover:underline text-lg sm:text-xl font-semibold font-jakarta leading-snug">
