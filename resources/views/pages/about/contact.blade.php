...
@section('content')
  <main
    ...
    <div class="relative z-10 grid w-full main-wrapper px-4 grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
      ...
      <div class="max-w-lg space-y-10">
        ...
        <div class="space-y-6 pt-4">
          ...
          <div class="flex items-center gap-4 text-sky-50">
            ...
            <span class="text-base font-medium">Email: {{ $contact->email }}</span>
          </div>
          <div class="flex items-center gap-4 text-sky-50">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      @if ($inbox->show_inbox_form)
        <div class="relative overflow-hidden rounded-2xl bg-white p-4 text-slate-800 shadow-2xl sm:p-12">
          <svg
            class="pointer-events-none absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 transform text-slate-200"
          ...
          <div class="relative z-10 space-y-8">
            <div>
              <h2 class="mb-1 text-3xl font-semibold text-slate-900 font-jakarta ">{{ t('contactPage_form_title') }}
              </h2>
